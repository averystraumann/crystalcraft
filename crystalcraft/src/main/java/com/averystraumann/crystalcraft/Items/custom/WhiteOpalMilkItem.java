...
public class WhiteOpalMilkItem extends MilkBucketItem {
    public WhiteOpalMilkItem(Properties p_42921_) {
        super(p_42921_);
    }
    @Override
    public ItemStack finishUsingItem(ItemStack p_42923_, Level p_42924_, LivingEntity p_42925_) {
        if (!p_42924_.isClientSide) p_42925_.addEffect(new MobEffectInstance(MobEffects.NIGHT_VISION,1000)); // FORGE - move up so stack.shrink does not turn stack into air
