...
public class SapphireCowModel extends EntityModel<SapphireCowEntity> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(crystalcraft.MODID, "sapphire_cow"), "main");
    ...
    public SapphireCowModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(SapphireCowEntity p_103509_, float p_103510_, float p_103511_, float p_103512_, float p_103513_, float p_103514_) {
