...
public class AmethystCowModel extends EntityModel<AmethystCowEntity> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(crystalcraft.MODID, "amethyst_cow"), "main");
    ...
    public AmethystCowModel(ModelPart root) {
